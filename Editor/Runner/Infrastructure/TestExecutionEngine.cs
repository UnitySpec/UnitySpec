...
namespace UnitySpec.Infrastructure
{
    public class TestExecutionEngine : ITestExecutionEngine
    {
        ...
        private object ExecuteStep(IContextManager contextManager, StepInstance stepInstance)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    OnStepStart();
                    result = ExecuteStepMatch(match, arguments, out duration);
        ...
        protected virtual object ExecuteStepMatch(BindingMatch match, object[] arguments, out TimeSpan duration)
        {
            ...
            try
            {
                return _bindingInvoker.InvokeBinding(match.StepBinding, _contextManager, arguments, _testTracer, out duration);
            }
            finally
            {
        ...
        public virtual object Step(StepDefinitionKeyword stepDefinitionKeyword, string keyword, string text, string multilineTextArg, Table tableArg)
        {
            ...
            try
            {
                ...
                result = ExecuteStep(_contextManager, stepInstance);
            }
            finally
            {
