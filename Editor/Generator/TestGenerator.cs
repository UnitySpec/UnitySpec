...
namespace UnityFlow.Generator
{
    public class TestGenerator : ErrorHandlingTestGenerator, ITestGenerator
    {
        ...
        protected string GetGeneratedTestCode(FeatureFileInput featureFileInput)
        {
            ...
            var header = GetUnityFlowHeader();
            var footer = GetUnityFlowFooter();
        ...
        {
            string targetNamespace = GetTargetNamespace(featureFileInput) ?? "UnityFlow.GeneratedTests";
        ...
        protected SyntaxToken GetUnityFlowHeader()
        {
            return Token(
                        TriviaList(
                            new[]{
        ...
        protected SyntaxToken GetUnityFlowFooter()
        {
            return Token(
                    TriviaList(
                        new[]{
