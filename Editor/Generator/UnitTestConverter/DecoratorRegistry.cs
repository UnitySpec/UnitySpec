...
namespace UnityFlow.Generator.UnitTestConverter
{
    public interface IDecoratorRegistry
    {
        ...
        void DecorateTestMethod(TestClassGenerationContext generationContext, MethodDeclarationSyntax testMethod, IEnumerable<Tag> tags, out List<string> unprocessedTags);
    }
    ...
    public class DecoratorRegistry : IDecoratorRegistry
    {
        ...
        private class TestMethodClassDecoratorWrapper : ITestMethodDecorator
        {
            ...
            public bool CanDecorateFrom(TestClassGenerationContext generationContext, MethodDeclarationSyntax testMethod)
            {
                return testClassDecorator.CanDecorateFrom(generationContext);
            }

            public void DecorateFrom(TestClassGenerationContext generationContext, MethodDeclarationSyntax testMethod)
            {
        ...
        public void DecorateTestMethod(TestClassGenerationContext generationContext, MethodDeclarationSyntax testMethod, IEnumerable<Tag> tags, out List<string> unprocessedTags)
        {
            Decorate(testMethodDecorators, testMethodTagDecorators, generationContext, testMethod, tags, out unprocessedTags);
        }

        private void Decorate(List<ITestMethodDecorator> decorators, List<ITestMethodTagDecorator> tagDecorators, TestClassGenerationContext generationContext, MethodDeclarationSyntax testMethod, IEnumerable<Tag> tags, out List<string> unprocessedTags)
        {
